{
  ...
  nixConfig = {
    extra-substituters = "https://nix-cache-vim1s-eu-west-3.s3.eu-west-3.amazonaws.com";
    extra-trusted-public-keys = "nix-cache-vim1s-eu-west-3:pQFFM6oS1PRZL3CahJVf2PWpExUSStx2IBqfHCwgQSo=";
  };
